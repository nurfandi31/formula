...
<template>
  <header class="h-16 bg-white/80 border-b border-slate-250/60 backdrop-blur-md px-6 flex items-center justify-between sticky top-0 z-20 shadow-xs">
    ...
    <div class="flex items-center gap-6">
      ...
      <div class="relative profile-dropdown-container">
        <button @click="isProfileMenuOpen = !isProfileMenuOpen" class="flex items-center gap-3 cursor-pointer hover:opacity-80 transition-opacity">
          ...
          <div class="w-10 h-10 rounded-lg overflow-hidden border border-slate-200 shadow-sm bg-slate-100 flex-shrink-0">
