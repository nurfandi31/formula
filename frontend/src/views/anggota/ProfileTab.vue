...
<template>
  <div class="space-y-8 animate-in fade-in duration-300">
    <div class="bg-slate-900/20 border border-slate-850 rounded-[2.5rem] p-6 sm:p-10 flex flex-col md:flex-row gap-6 md:gap-10 items-center">
    ...
    <div class="space-y-4">
      ...
      <div v-if="myPosts.length === 0" class="text-center py-16 bg-slate-900/10 border border-dashed border-slate-850 rounded-[2rem] space-y-4">
