  ...
  <div class="space-y-6 animate-in fade-in duration-300">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-6 max-w-3xl mx-auto">
      <div
        ...
        class="p-5 bg-slate-900/20 border border-slate-850 rounded-[1.5rem] flex items-center gap-4 hover:border-emerald-500/20 hover:bg-slate-900/40 transition-all cursor-pointer group"
      >
